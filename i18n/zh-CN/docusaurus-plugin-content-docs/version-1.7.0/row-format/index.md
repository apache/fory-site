...
| 布局         | 语言支持                    | 兼容性                      |
| ------------ | --------------------------- | --------------------------- |
| Standard Row | Java、Python、C++、Rust、Go | 共享的 Standard Row 布局    |
| Compact Row  | Java                        | 仅 Java、面向空间优化的布局 |

## Standard Row

Standard Row 是 Java、Python、C++、Rust 和 Go 之间可互操作的布局。

### 功能特性

- **零拷贝随机访问**：直接从编码数据中读取选定字段。
- **部分反序列化**：只重建应用所需的值。
- **跨语言兼容**：在 Java、Python、C++、Rust 和 Go 之间共享 Standard Row 字节。
...
| Go     | 兼容                | [Go](go.md)         | 结构体编码器和零拷贝 Row 视图  |
...
Compact Row。Java、Python、C++、Rust 和 Go 互操作请使用 Standard Row。
