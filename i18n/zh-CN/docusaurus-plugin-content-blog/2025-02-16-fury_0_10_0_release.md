...
title: Fury v0.10.0 发布
authors: [wangweipeng]
tags: [fury]
---

Apache Fury 团队很高兴宣布 0.10.0 版本发布。 这是一个重要版本，包含来自 16 位贡献者的[27 PR](https://github.com/apache/fury/compare/v0.9.0...v0.10.0)。 请参阅[Install](https://fury.apache.org/docs/docs/start/install)页面了解如何获取适用于你平台的库。
...
**完整更新日志**：https://github.com/apache/fury/compare/v0.9.0...v0.10.0
