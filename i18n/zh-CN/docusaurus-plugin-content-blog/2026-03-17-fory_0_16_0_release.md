...
Apache Fory 团队很高兴宣布 0.16.0 版本正式发布。这是一个重要版本，包含来自 17 位贡献者的 [144 个 PR](https://github.com/apache/fory/compare/v0.14.1...v0.15.0)。请访问 [Install 页面](https://fory.apache.org/docs/start/install) 获取各平台安装方式。
