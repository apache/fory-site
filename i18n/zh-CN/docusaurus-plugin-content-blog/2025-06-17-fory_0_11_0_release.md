...
title: Fory v0.11.0 发布
authors: [chaokunyang]
tags: [fory]
---

Apache Fory 团队很高兴宣布 0.11.0 版本发布。 这是一个重要版本，包含来自 39 位贡献者的[177 PR](https://github.com/apache/fory/compare/v0.10.3...v0.11.0)。 请参阅[Install](https://fury.apache.org/docs/docs/start/install)页面了解如何获取适用于你平台的库。
...
**完整更新日志**：https://github.com/apache/fory/compare/v0.10.3...v0.11.0-rc2
