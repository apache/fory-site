...
title: Fury v0.8.0 发布
authors: [chaokunyang]
tags: [fury]
---

Apache Fury 团队很高兴宣布 0.8.0 版本发布。这是一个重要版本，包含来自 7 位贡献者的[23 PR](https://github.com/apache/fury/compare/v0.7.1...v0.8.0)。请参阅[Install](https://fury.apache.org/docs/docs/start/install)页面了解如何获取适用于你平台的库。
