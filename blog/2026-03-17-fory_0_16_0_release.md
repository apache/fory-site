...
The Apache Fory team is pleased to announce the 0.16.0 release. This is a major release that includes [91 PR](https://github.com/apache/fory/compare/v0.14.1...v0.15.0) from 17 distinct contributors. See the [Install](https://fory.apache.org/docs/start/install) Page to learn how to get the libraries for your platform.
