...
out = fory.deserialize(data)`},{id:"rust",label:"Rust",installLanguage:"bash",install:"cargo add fory@1.7.5",codeLanguage:"rust",guide:"/docs/object-serialization/rust/",summary:"Rust uses derive macros for type-safe structs and supports both xlang and native payloads.",code:`use fory::{Error, Fory, ForyStruct};
...
fn main() -> Result<(), Error> {
    ...
    Ok(())
}`},{id:"go",label:"Go",installLanguage:"bash",install:"go get github.com/apache/fory/go/fory@v1.7.5",codeLanguage:"go",guide:"/docs/object-serialization/go/",summary:"Go supports xlang and native modes with exported structs, circular references, and schema-aware serializers.",code:`type Person struct {
    Name string
    Age  int32
}
...
auto out = fory.deserialize<Person>(bytes).value();`},{id:"javascript",label:"JavaScript",installLanguage:"bash",install:"npm install @apache-fory/core@1.7.5 @apache-fory/hps@1.7.5",codeLanguage:"typescript",guide:"/docs/object-serialization/javascript/",summary:"JavaScript/TypeScript is xlang-only, schema-driven, and runs in Node.js or browsers.",code:`import Fory, { Type } from "@apache-fory/core";
...
const out = deserialize(payload);`},{id:"csharp",label:"C#",installLanguage:"bash",install:"dotnet add package Apache.Fory --version 1.7.5",codeLanguage:"csharp",guide:"/docs/object-serialization/csharp/",summary:".NET support uses source-generated serializers for Fory structs, enums, and unions.",code:`using Apache.Fory;
...
Person out = fory.Deserialize<Person>(payload);`},{id:"swift",label:"Swift",installLanguage:"swift",install:'.package(url: "https://github.com/apache/fory.git", exact: "1.7.5")',codeLanguage:"swift",guide:"/docs/object-serialization/swift/",summary:"Swift uses @ForyStruct, @ForyEnum, and @ForyUnion macros for xlang-compatible models.",code:`import Fory
...
final out = fory.deserialize<Person>(payload);`},{id:"scala",label:"Scala",installLanguage:"sbt",install:'libraryDependencies += "org.apache.fory" %% "fory-scala" % "1.7.5"',codeLanguage:"scala",guide:"/docs/object-serialization/scala/",summary:"Scala builds on Fory Java with optimized serializers for case classes, collections, tuples, and Option.",code:`import org.apache.fory.scala.ForyScala
...
val out = fory.deserialize(payload).asInstanceOf[Person]`},{id:"kotlin",label:"Kotlin",installLanguage:"kotlin",install:`implementation("org.apache.fory:fory-kotlin:1.7.5")
ksp("org.apache.fory:fory-kotlin-ksp:1.7.5")`,codeLanguage:"kotlin",guide:"/docs/object-serialization/kotlin/",summary:"Kotlin adds data-class support, Android guidance, and KSP static serializers for xlang/schema mode.",code:`import org.apache.fory.kotlin.ForyKotlin
