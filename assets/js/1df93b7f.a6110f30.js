...
out = fory.deserialize(data)`},{id:"rust",label:"Rust",installLanguage:"bash",install:"cargo add fory@1.3.0",codeLanguage:"rust",guide:"/docs/guide/rust/",summary:"Rust uses derive macros for type-safe structs and supports both xlang and native payloads.",code:`use fory::{Error, Fory, ForyStruct};
...
const out = deserialize(payload);`},{id:"csharp",label:"C#",installLanguage:"bash",install:"dotnet add package Apache.Fory --version 1.3.0",codeLanguage:"csharp",guide:"/docs/guide/csharp/",summary:".NET support uses source-generated serializers for Fory structs, enums, and unions.",code:`using Apache.Fory;
...
Person out = fory.Deserialize<Person>(payload);`},{id:"swift",label:"Swift",installLanguage:"swift",install:'.package(url: "https://github.com/apache/fory.git", exact: "1.3.0")',codeLanguage:"swift",guide:"/docs/guide/swift/",summary:"Swift uses @ForyStruct, @ForyEnum, and @ForyUnion macros for xlang-compatible models.",code:`import Fory
...
final out = fory.deserialize<Person>(payload);`},{id:"scala",label:"Scala",installLanguage:"sbt",install:'libraryDependencies += "org.apache.fory" %% "fory-scala" % "1.3.0"',codeLanguage:"scala",guide:"/docs/guide/scala/",summary:"Scala builds on Fory Java with optimized serializers for case classes, collections, tuples, and Option.",code:`import org.apache.fory.scala.ForyScala
...
val out = fory.deserialize(payload).asInstanceOf[Person]`},{id:"kotlin",label:"Kotlin",installLanguage:"kotlin",install:`implementation("org.apache.fory:fory-kotlin:1.3.0")
ksp("org.apache.fory:fory-kotlin-ksp:1.3.0")`,codeLanguage:"kotlin",guide:"/docs/guide/kotlin/",summary:"Kotlin adds data-class support, Android guidance, and KSP static serializers for xlang/schema mode.",code:`import org.apache.fory.kotlin.ForyKotlin
