...
The latest source release is 1.2.0:
...
```bash
sha512sum --check apache-fory-1.2.0-src.tar.gz.sha512
```

It should output something like:

```bash
apache-fory-1.2.0-src.tar.gz: OK
```
...
```bash
gpg --verify apache-fory-1.2.0-src.tar.gz.asc apache-fory-1.2.0-src.tar.gz
```
