...
The latest source release is 1.7.3:

| Version | Date       | Source                                                                                                                                                                                                                                                                        | Release Notes                                                       |
| ------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| 1.7.3   | 2026-09-16 | [source](https://www.apache.org/dyn/closer.lua/fory/1.7.3/apache-fory-1.7.3-src.tar.gz?action=download) [asc](https://downloads.apache.org/fory/1.7.3/apache-fory-1.7.3-src.tar.gz.asc) [sha512](https://downloads.apache.org/fory/1.7.3/apache-fory-1.7.3-src.tar.gz.sha512) | [release notes](https://github.com/apache/fory/releases/tag/v1.7.3) |
...
```bash
sha512sum --check apache-fory-1.7.3-src.tar.gz.sha512
```

It should output something like:

```bash
apache-fory-1.7.3-src.tar.gz: OK
```
...
```bash
gpg --verify apache-fory-1.7.3-src.tar.gz.asc apache-fory-1.7.3-src.tar.gz
```

If something like the following appears, it means the signature is correct:

```bash
gpg: Signature made Sun Sep 13 00:59:21 2026 CST
