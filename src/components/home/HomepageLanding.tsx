...
const out = deserialize(payload);`,
  },
  {
    ...
    label: "C#",
    installLanguage: "bash",
    install: `dotnet add package Apache.Fory --version 1.2.0`,
    codeLanguage: "csharp",
...
Person out = fory.Deserialize<Person>(payload);`,
  },
  {
    ...
    install: `.package(url: "https://github.com/apache/fory.git", exact: "1.2.0")`,
    codeLanguage: "swift",
...
final out = fory.deserialize<Person>(payload);`,
  },
  {
    ...
    label: "Scala",
    installLanguage: "sbt",
    install: `libraryDependencies += "org.apache.fory" %% "fory-scala" % "1.2.0"`,
    codeLanguage: "scala",
...
val out = fory.deserialize(payload).asInstanceOf[Person]`,
  },
  {
    ...
    install: `implementation("org.apache.fory:fory-kotlin:1.2.0")
ksp("org.apache.fory:fory-kotlin-ksp:1.2.0")`,
    codeLanguage: "kotlin",
